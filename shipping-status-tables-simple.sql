...
-- 9. 配送ステータスの初期データ挿入（簡素化版）
INSERT INTO shipping_statuses (status_code, status_name, description, sort_order) VALUES
  ('PENDING', '配送準備中', '注文確定後、配送準備を行っています', 1),
  ('SHIPPED', '発送済み', '配送業者に商品を引き渡しました', 2),
  ('IN_TRANSIT', '配送中', '配送業者が配送中です', 3),
  ('OUT_FOR_DELIVERY', '配達中', 'お客様のお住まいに向けて配達中です', 4),
  ('DELIVERED', '配達完了', 'お客様に商品をお届けしました', 5)
