            ...
            <Card key={address.id} className="bg-white shadow-sm hover:shadow-md transition-shadow">
              <CardContent className="p-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="text-sm text-gray-900">{address.address1}</div>
                  {address.address2 && (
                    <div className="text-sm text-gray-900">{address.address2}</div>
                  )}
        ...
        {addresses.length === 0 && (
          <Card className="bg-white shadow-sm">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-lg text-gray-600 mb-4">配送先が登録されていません</p>
              <p className="text-sm text-gray-500 mb-6">
                配送先を登録すると、注文時に簡単に選択できます
              </p>
              <Button
                onClick={() => setShowForm(true)}
                className="bg-blue-600 hover:bg-blue-700 text-white"
              ...
              <CardContent className="p-6">
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="is_default">デフォルトの配送先に設定</Label>
                  </div>
